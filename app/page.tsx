    ...
    <main className="text-white">
      ...
      <section className="bg-navy-swirl min-h-[55vh] flex flex-col justify-center items-center px-6">
        <div className="max-w-5xl text-center">
          <h1 className="font-bold" style={{ fontSize: '7rem', marginTop: '3rem', marginBottom: '1.5rem' }}>I love you</h1>
          {/* Navy Blue message box */}
          <div
      ...
      <section className="bg-navy-swirl min-h-[55vh] flex flex-col justify-center items-center px-6">
        <div className="max-w-5xl text-center mx-auto" style={{ paddingLeft: '8rem', paddingRight: '8rem' }}>
          <h2 className="text-4xl font-bold mb-4">Thank You For Every Memory</h2>
